...
{
    class ClassFeatureNameList
    {
        public string[] iupacList = new string[24] {
            "M", "m", "R", "r", "W", "w", "S", "s",
            "Y", "y", "K", "k", "V", "v", "H", "h",
            "D", "d", "B", "b", "X", "x", "N", "n"
        };

        public string[] motifFeatureName = new string[353] { 
            ...
            "%G+C", "CpG ratio", "TG", "AAWGGR", "CCDGGV", "CCCSGS", "AAATKT", "BCCCWG", "GSCCCS", "ATGVAA",
            "GGVCCH", "CCGSSC", "TGVAAA", "CCCWGH", "CGSCCS", "CWGAMA", "GGSCTB", "VGCGGG", "AATKAA", "CCTGMV",
            "GRGCSC", "AAATGV", "GMCCCN", "TCCSSG", "TGRAAT", "SCCWCR", "KCCSGC", "GVAAAT", "WGCCCH", "CTCCSS",
            "TRAATT", "CKGSCM", "SGMGCC"
        };
        ...
        public string[] motifFeatureName4 = new string[256] {
            "AAAA", "AAAT", "AAAG", "AAAC", "AATA", "AATT", "AATG", "AATC", "AAGA", "AAGT",
            "AAGG", "AAGC", "AACA", "AACT", "AACG", "AACC", "ATAA", "ATAT", "ATAG", "ATAC",
            "ATTA", "ATTT", "ATTG", "ATTC", "ATGA", "ATGT", "ATGG", "ATGC", "ATCA", "ATCT",
            "ATCG", "ATCC", "AGAA", "AGAT", "AGAG", "AGAC", "AGTA", "AGTT", "AGTG", "AGTC",
            ...
            "CGTG", "CGTC", "CGGA", "CGGT", "CGGG", "CGGC", "CGCA", "CGCT", "CGCG", "CGCC",
            "CCAA", "CCAT", "CCAG", "CCAC", "CCTA", "CCTT", "CCTG", "CCTC", "CCGA", "CCGT",
            "CCGG", "CCGC", "CCCA", "CCCT", "CCCG", "CCCC"
        };

        public string[] motifFeatureName3 = new string[64] {
        ...
        public string motifFeatureName2 = "TG";

        public string[] motifFeatureNameR = new string[2] {
            "%G+C", "CpG ratio"
        };
        ...
        public string[] histoneModificationFeatureName = new string[38] {
        ...
        public Hashtable IUPACHT = new Hashtable();                        // 保存 IUPAC 对应值的哈希表

        public ClassFeatureNameList()
        {
            ...
            // 初始化哈希表
            foreach (string iupac in iupacList)
            {
                switch (iupac)
                {
                    case "M":
